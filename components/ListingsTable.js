...
import { ChevronUpIcon, ChevronDownIcon, FunnelIcon, SparklesIcon } from '@heroicons/react/24/outline'
      ...
      <div className="bg-white shadow overflow-hidden sm:rounded-lg">
        <div className="divide-y divide-gray-200">
          {filteredAndSortedListings.map((listing) => (
            <div key={listing.article_id} className="w-full">
              <div 
                className={`p-6 cursor-pointer hover:bg-gray-50 ${
                  expandedId === listing.article_id ? 'bg-blue-50' : ''
                }`}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <button
                          onClick={(e) => {
                            e.stopPropagation()
                            router.push(`/dashboard/listing/${listing.article_id}`)
                          }}
                      ...
                      {listing.iphone_analysis && (
                        <div className="bg-blue-50 p-4 rounded-lg shadow-sm space-y-4 border border-blue-100">
                          ...
                          <div className="space-y-3">
                            ...
                            <div>
                              <span className="text-xs font-medium text-blue-700">Condition Rating</span>
                              <p className="mt-1 text-sm text-blue-800">
                                {listing.iphone_analysis.rating || 'Not Rated'}
                              </p>
                            </div>
                            <div>
                              <span className="text-xs font-medium text-blue-700">Highlights</span>
                              <p className="mt-1 text-sm text-blue-800">
                                {listing.iphone_analysis.highlights || 'No highlights available'}
                              </p>
                            </div>
                          </div>
                        </div>
